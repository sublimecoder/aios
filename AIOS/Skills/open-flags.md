...
**Steps:**
1. Grep `AIOS/Projects/**/*.md` for the flag markers: `⚠️`, `OPEN —`, `OPEN:`.
...
**Dependencies:** `AIOS/Projects/`, [[aios-ingest]] (calls this per touched project), [[Log]] (first-seen dates + escalations). **Output:** the flag register + any escalation Log lines; notes untouched except genuine resolutions.
